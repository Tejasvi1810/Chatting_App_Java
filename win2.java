...
//win2 client ki tarah act krega...
public class win2  implements ActionListener
{
	...
	win2()
	{
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("pic.png"));
		Image i5 = i4.getImage().getScaledInstance(50,50,Image.SCALE_DEFAULT);
		ImageIcon i6 = new ImageIcon(i5);
		 JLabel profile = new JLabel(i6);
		profile.setBounds(30,15,50,50);
		p1.add(profile);
		...
		JLabel name = new JLabel("Akshita");
